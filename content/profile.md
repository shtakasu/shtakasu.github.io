...
## About me
スクリプス研究所の[Ann Kennedy研究室](https://www.kennedylab.org/)にて、ポスドクとして勤務しています。**非線形力学や統計物理学を中心とした数学理論**と**計算機実験**を用いて、**脳のダイナミクス、表現、機能との関係**を解明することを目指しています。
...
## Main Employment
**・ 2025.12- Current**  
Postdoctral Associate, [The Scripps Research Institute](https://www.scripps.edu/), CA, USA 
